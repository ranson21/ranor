...
setup-app:
	...
	@cd $(RANOR_DIR) && flutter pub get
	@cd $(RANOR_DIR) && flutter pub run build_runner build --delete-conflicting-outputs
...
## Start RaNor app in development mode
dev-app:
	@cd $(RANOR_DIR) && flutter run -d chrome
